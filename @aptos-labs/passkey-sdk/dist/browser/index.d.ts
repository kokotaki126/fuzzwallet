...
declare enum AssertionSignatureVariant {
    Secp256r1 = 0
}
/**
 * BCS types
 ...
 * Secp256r1
 */
type GenerateAccountWithSingleSignerSecp256r1Key = {
    scheme: SigningSchemeInput.Secp256r1Ecdsa;
    legacy?: false;
};
type GenerateAccount = GenerateAccountWithEd25519 | GenerateAccountWithSingleSignerSecp256k1Key | GenerateAccountWithSingleSignerSecp256r1Key;
...
declare function signWithPasskey(args: {
    publicKey: PublicKey;
 ...
 * @return The signer AccountAuthenticator
 */
declare function getAuthenticatorForWebAuthn(args: {
    publicKey: PublicKey;
    signature: HexInput;
